...
<tr><td colspan="2" align="center" class="toptd"><span class="cityspan">Delete Blood Group</span></td></tr>
<tr><td class="lefttd" align="center">Select Blood Group</td><td><select name="s2" required><option value="">Select</option>
