            ...
            <div class="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li class="current"><a href="requests.php">Request Blood</a></li>
...
<div style="height:550px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px;border:2px solid red; box-shadow:4px 1px 20px black;">
     <form method="post" enctype="multipart/form-data">
 <table cellpadding="0" cellspacing="0" width="700px" height="500px" style="margin:auto" >

   <tr><td colspan="2" align="center"><h1>Request For Blood</h1></td></tr>
...
<tr><td class="lefttd" align="center">Age</td><td><input type="number" name="t2" required="required" pattern="[0-9]{2,2}" title="please enter only  numbers between 2 to 2 for age" /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" align="center">Mobile No</td><td><input type="number" name="t3"  required="required" maxlength="10" pattern="[0-9]{10,12}" title="please enter only numbers between 10 to 12 for mobile no." /></td></tr>
 <tr><td>&nbsp;</td></tr>
